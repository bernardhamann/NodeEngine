    ...
    render: function() {
        ...
        if (self.props.meta.query.batch){
            ...
            if (downCycleTest > 0){
                downCycle = element(
                    "input",
                    { type: "submit" , value: downCycleTest, className: "pagebutton"}
                )
            }
            else {
                downCycle = element(
            ...
            var cycleNextButton = element(
                ...
                element(
                    "input",
                    { type: "submit" , value: parseInt(self.props.meta.query.batch) + 1, className: "pagebutton"}
                )
            )
                    ...
                    self.props.apiref[apirefIndex].fields.forEach(function(field, index2){
                        ...
                        editItem.push(element(
                            ...
                            element(
                                ...
                                element(
                                    "input",
                                    { type: "submit" , value: "Change " + field.data}
                                )
                            )
                        ))
        ...
        var addItem = element(
            "div",
            {
                ...
                className: "ui text container center aligned four wide column"
            },
            element(
                "form",
                ...
                <div className="ui grid">
                    ...
                    <div className="twelve column">
                        ...
                        <div className="ui grid">
                            ...
                            <div className="sixteen column center aligned row">
                            ...
                            <div className="sixteen column center aligned row">
                                ...
                                <div className="ui stackable grid">
                                    ...
                                    <div className="ui center aligned eight wide column" style={
                                {
                                    background: "red",
                                    color: "white"
                                }
                                        ...
                                        {cycleCurrentLabel}
                                        <br/>
                                        {self.props.meta.query.message && self.props.meta.query.message}
                                    </div>

                                    <div className="ui text container center aligned four wide column">
                                        {cycleNextButton}
                                    </div>
                        ...
                        <div className="sixteen column center aligned row">
                            ...
                            <div className="sixteen column center aligned stackable grid">
                        ...
                        <div className="sixteen column center aligned row">
                            ...
                            <h2> add new {self.props.meta.params.apiName} item 3 </h2>
